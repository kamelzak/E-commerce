                ...
                <tbody>
                    ...
                    @foreach (Cart::content() as $product)
                        ...
                        <th scope="row" class="border-0">
                            <div class="p-2">
                            <img src="{{ $product->model->photo }}" alt="" width="70" class="img-fluid rounded shadow-sm">
                            <div class="ml-3 d-inline-block align-middle">
                                <h4 class="mb-0 text-dark d-inline-block align-middle">{{ $product->model->title }}</h4>
                                <span class="text-success font-weight-normal font-italic d-block">Category: Watches</span>
                            </div>
                            </div>
                        </th>
